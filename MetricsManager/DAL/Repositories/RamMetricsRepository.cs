...
namespace MetricsManager.DAL.Repositories
{
    public class RamMetricsRepository : IRamMetricsRepository
    {
        ...
        public void AddRange(List<RamMetric> items)
        {
            using var connection = new SQLiteConnection(_connectionString);
        ...
        public IList<RamMetric> GetByAgentId(int agentid)
        {
            var connection = new SQLiteConnection(_connectionString);
            var query = connection
                .QueryAsync<RamMetric>($"SELECT Id, Time, Value, AgentId FROM {_tableName} WHERE agentid = @agentid",
                    new
                    {
                        agentid = agentid
                    }).Result.ToList();
        ...
        public IList<RamMetric> GetByTimePeriod(int agentId, DateTimeOffset fromTime, DateTimeOffset toTime)
        {
            var connection = new SQLiteConnection(_connectionString);
            var query = connection
